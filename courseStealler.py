...
res = requests.get("https://kiki.ccu.edu.tw/~ccmisp06/cgi-bin/class_new/Add_Course01.cgi?session_id="+session_id+"&dept=I001&grade=1&page=1&cge_cate=2&cge_subcate=3")
